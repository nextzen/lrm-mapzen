...
(function() {
  ...
  L.Routing.MapzenMatrix = L.Class.extend({
    options: {
      timeout: 30 * 1000
    },
    ...
    buildRouteUrl: function(waypoints, options) {
      ...
      return serviceUrl + '/optimized_route?json=' +
  ...
  L.Routing.matrix = function(accessToken, options) {
    return new L.Routing.MapzenMatrix(accessToken, options);
  };

  module.exports = L.Routing.MapzenMatrix;
})();
...
},{"corslite":1,"polyline":2}],5:[function(require,module,exports){
(function (global){
(function() {
  'use strict';
